        ...
        <div class="row layout-top-spacing">   
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-4">
                ...
                <div class="single-post-content">
                    ...
                    <div class="featured-image" style="position: relative; background: lightblue url({{$post->image}}) no-repeat fixed center; height: 650px; background-position: center; background-size: cover; background-attachment: inherit; border-radius: 20px; overflow: hidden;">
